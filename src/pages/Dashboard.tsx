...
export default function Dashboard() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative overflow-hidden bg-[#FFFFFF] border-2 border-[#0A0A0A] mb-6">
        <div className="relative px-8 py-10 sm:px-12 sm:py-14 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#E30A17]/[0.06] border border-[#E30A17]/10 mb-6">
            <span className="live-dot" />
            <span className="text-[11px] font-bold tracking-[3px] text-[#E30A17] uppercase">Canlı Veri</span>
          </div>

          <div className="mb-3">
            <span className="stat-number text-8xl sm:text-9xl text-[#0A0A0A]">{day}</span>
          </div>
          ...
          <p className="text-[rgba(10,10,10,0.4)] text-sm sm:text-base max-w-lg mx-auto mt-3 leading-relaxed">
        ...
        <aside className="space-y-4">
          ...
          <div className="border-2 border-[#0A0A0A] bg-white p-5">
            ...
            {shadowResult ? (
                  ...
                  {Object.entries(shadowResult.checks).map(([key, check]) => {
                    ...
                    return (
                      <span key={key} className={`font-mono text-[9px] font-bold px-1.5 py-0.5 border-2 ${
                        check.status === 'pass' ? 'text-[#0A0A0A] border-[#0A0A0A]' :
                        check.status === 'fail' ? 'text-[#E30A17] border-[#E30A17]' : 'text-[rgba(10,10,10,0.3)] border-[rgba(10,10,10,0.15)]'
                      }`}>
              ...
              <div className="font-mono text-[11px] text-[rgba(10,10,10,0.35)]">Henüz kontrol yapılmadı</div>
            )}
          </div>
          ...
          {/* Footer Info */}
          <div className="px-1 space-y-1 font-mono text-[10px] text-[rgba(10,10,10,0.3)] tracking-[1px]">
